...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TeleportTarget) DeepCopyInto(out *TeleportTarget) {
	*out = *in
	out.IdentitySecretRef = in.IdentitySecretRef
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TeleportTarget.
func (in *TeleportTarget) DeepCopy() *TeleportTarget {
	if in == nil {
		return nil
	}
	out := new(TeleportTarget)
	in.DeepCopyInto(out)
	return out
}
