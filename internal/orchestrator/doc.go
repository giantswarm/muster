...
// MCPServer connections with bounded concurrency, probes connected MCPServers
// so that one that stops answering fails itself onto that same reconnect
// schedule, and publishes service state-change events to subscribers.
//
