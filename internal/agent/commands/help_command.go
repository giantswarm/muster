...
func (h *HelpCommand) showGeneralHelp() {
	...
	h.output.OutputLine("")
	h.output.OutputLine("Examples (call command supports both key=value and JSON syntax):")
	...
	h.output.OutputLine("")
	h.output.OutputLine("Tip: Type 'call <tool>' without arguments to see available parameters")
}
