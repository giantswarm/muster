...
//
//	cfg := app.NewConfig(true, "")  // debug enabled
...
//
//	cfg := app.NewConfig(true, "")  // debug mode
//	application, err := app.NewApplication(cfg)
//	if err != nil {
//	    return fmt.Errorf("bootstrap failed: %w", err)
//	}
...
//
// **Graceful Degradation**: Optional components (Workflow definitions) log
// warnings but don't halt initialization.
//
