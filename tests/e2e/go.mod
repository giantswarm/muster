...
require github.com/giantswarm/apptest-framework/v5 v5.2.2
...
require (
	...
	github.com/giantswarm/clustertest/v5 v5.5.1 // indirect
	...
	github.com/mittwald/go-helm-client v0.13.2 // indirect
