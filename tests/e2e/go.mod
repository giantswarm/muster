...
require github.com/giantswarm/apptest-framework/v4 v4.2.0
...
require (
	...
	github.com/giantswarm/cluster-standup-teardown/v5 v5.2.0 // indirect
	github.com/giantswarm/clustertest/v4 v4.3.1 // indirect
