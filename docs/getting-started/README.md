...
- **Configuration** - System and aggregator management
- **Services** - Service lifecycle (aggregator and MCP server processes)
- **MCP Servers** - External tool provider management
